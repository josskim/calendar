  ...
  return (
    <AuthGate>
      <div className="flex flex-col min-h-screen bg-[#f8f6f6] dark:bg-[#201214] text-slate-900 dark:text-slate-100 font-['Manrope',_ui-sans-serif,_system-ui]">
        ...
        <div className="md:hidden flex flex-col w-full bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800">
          {/* Row 1: Logo and User Info */}
          <div className="w-full px-4 h-12 flex items-center justify-between border-b border-zinc-100 dark:border-zinc-800/50">
            <Link href="/admin/calendar" className="flex items-center gap-2 shrink-0">
              <div className="bg-[#DB5461] text-white p-1 rounded-md flex items-center justify-center">
                <CalendarTodayIcon className="w-4 h-4" />
              </div>
              <h1 className="text-sm font-extrabold tracking-tight text-[#DB5461] whitespace-nowrap">
                StayNamcheon
              </h1>
            </Link>
          ...
          <div className="w-full px-2 h-12 flex items-center justify-between gap-1 overflow-x-auto no-scrollbar">
            <NavLinks compact />
            <div className="flex items-center gap-0.5 pl-2 border-l border-zinc-100 dark:border-zinc-800 shrink-0">
              <button
                type="button"
                className="p-1.5 text-slate-500 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-full transition-colors"
